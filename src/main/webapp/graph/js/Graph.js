	...
	try
	{
		if (navigator != null && navigator.language != null)
		{
			...
			mxGraph.prototype.pageFormat = (lang === 'en-us' || lang === 'en-ca' || lang === 'es-mx') ?
				mxConstants.PAGE_FORMAT_LETTER_PORTRAIT : new mxRectangle(0, 0, 900, 250);
		}
	}
	catch (e)
	{
...
{
    //20为滚动条和border宽度，避免出现一侧滚动条时影响另一侧
	this.pageFormat.width=this.container.offsetWidth-20;
    this.pageFormat.height=this.container.offsetHeight-20;
...
if (typeof mxVertexHandler != 'undefined')
{
	(function()
	{
		...
		{
            // CoreObjPanel.prototype.triangleUp = HoverIcons.prototype.triangleUp;
            // CoreObjPanel.prototype.triangleRight = HoverIcons.prototype.triangleRight;
            // CoreObjPanel.prototype.triangleDown = HoverIcons.prototype.triangleDown;
            // CoreObjPanel.prototype.triangleLeft = HoverIcons.prototype.triangleLeft;
            // CoreObjPanel.prototype.refreshTarget = HoverIcons.prototype.refreshTarget;
            // CoreObjPanel.prototype.roundDrop = HoverIcons.prototype.roundDrop;
