...
<head>
    ...
    <%--<script type="text/javascript" src="graph/js/Resultbar.js"></script>--%>
    <%--<script type="text/javascript" src="graph/js/Logs.js"></script>--%>
    <%--<script type="text/javascript" src="graph/js/StepMeasure.js"></script>--%>
    <%--<script type="text/javascript" src="graph/js/JobMeasure.js"></script>--%>
    <%--<script type="text/javascript"--%>
